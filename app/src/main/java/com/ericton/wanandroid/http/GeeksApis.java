...
import com.ericton.wanandroid.bean.main.login.LoginData;
import com.ericton.wanandroid.bean.main.search.TopSearchData;
import com.ericton.wanandroid.bean.main.search.UsefulSiteData;
import com.ericton.wanandroid.bean.navigation.NavigationListData;
import com.ericton.wanandroid.bean.project.ProjectClassifyData;
import com.ericton.wanandroid.bean.project.ProjectListData;
import com.ericton.wanandroid.bean.wx.WxAuthor;
...
public interface GeeksApis {
    ...
    @FormUrlEncoded
    Observable<BaseResponse<FeedArticleListData>> getSearchList(@Path("page") int page, @Field("k"
    ) String k);
    ...
    Observable<BaseResponse<ProjectListData>> getProjectListData(@Path("page") int page, @Query(
            "cid") int cid);
     ...
     */
    @GET("wxarticle/list/{id}/{page}/json")
    Observable<BaseResponse<FeedArticleListData>> getWxSearchSumData(@Path("id") int id, @Path(
            "page") int page, @Query("k") String k);
